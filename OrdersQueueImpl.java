 ...
 */
public class OrdersQueueImpl implements IOrders
{
    ...
    public boolean hasNext() 
    {
        ...
        return tacoQueue.size() > 0;
    }

    /**
     * Note that this method will remove the first (in terms of FIFO)
     * taco from the tacoQueue and return it.
     *
